...
#predicts the emission distribution for each of the 4 dependent
# variables:
...
```{r}
# est_gamma_group <- obtain_gamma(out_2st_c, level = "group")
# 
...
nonverbal_cov %>%
  group_by(diagnosis) %>%
  obtain_gamma(out_2st_c, level = "group")


plot(out_2st_c, component = "gamma", dep = diagnosis, col = Voc_col, 
     dep_lab = c("Patient vocalizing"), cat_lab = Voc_lab)
```
